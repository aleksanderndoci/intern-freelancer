...
import al.ikubinfo.internship.freelancer.repository.registration.ConfirmationTokenRepository;
import al.ikubinfo.internship.freelancer.repository.registration.RegistrationRepository;
...
public class RegistrationService implements UserDetailsService {
	...
	public String signUpUser(Users user) {
		boolean userExists = registrationRepository.findByEmail(user.getEmail()).isPresent();
		if (userExists) {
	...
	public int enableUser(String email) {
		return registrationRepository.enableUser(email);
	}
